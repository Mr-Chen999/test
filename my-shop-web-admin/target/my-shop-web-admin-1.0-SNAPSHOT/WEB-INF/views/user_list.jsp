            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <a href="/user/form" type="button" class="btn btn-sm btn-default"><i class="fa fa-plus"></i>
                                新增</a>&nbsp;&nbsp;&nbsp;
        ...
        $("#dataTable").DataTable({
            ...
            "columns": [
                    ...
                    }},
                {
                    ...
                    "data": function (row, type, val, meta) {
                        return '<a type="button" class="btn btn-sm btn-default"><i class="fa fa-search"></i> 查看</a>&nbsp;&nbsp;&nbsp;' +
                            '<a href="/user/form?id=' + row.id + '" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
...
<%--        _dataTable = App.initDataTables("/user/list", _columns);--%>
<%--    });--%>
